    ...
    <div
        ...
        <!-- Card -->
        <div class="bg-white rounded-lg shadow-md overflow-hidden flex flex-col  items-center group transition-all duration-300 hover:shadow-titre hover:scale-105">
            <!-- Image -->
            ...
            <div class="p-4 text-center flex-1 flex flex-col justify-between">
                <h3 class="text-lg font-bold text-titre flex-grow">
                    <a
                        ...
                        class="no-underline text-gray-800 hover:text-titre">
